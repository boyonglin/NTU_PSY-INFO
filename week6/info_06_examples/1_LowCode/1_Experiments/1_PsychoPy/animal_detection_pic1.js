...
let expName = 'animal_detection_pic1';  // from the Builder filename that created this script
let expInfo = {
    'session': '001',
    'participant': '',
};
...
psychoJS.start({
  ...
  expInfo: expInfo,
  resources: [
    {'name': 'animal_detection_pic1.csv', 'path': 'animal_detection_pic1.csv'},
    {'name': 'T01.jpg', 'path': 'T01.jpg'},
    {'name': 'T02.jpg', 'path': 'T02.jpg'},
    {'name': 'T03.jpg', 'path': 'T03.jpg'},
    {'name': 'D01.jpg', 'path': 'D01.jpg'},
    {'name': 'D02.jpg', 'path': 'D02.jpg'},
    {'name': 'D03.jpg', 'path': 'D03.jpg'},
  ]
});
...
function trialsLoopBegin(trialsLoopScheduler, snapshot) {
  return async function() {
    ...
    trials = new TrialHandler({
      ...
      trialList: 'animal_detection_pic1.csv',
...
function trialRoutineEachFrame() {
  return async function () {
    ...
    // *key_resp_2* updates
    if (t >= 1.2 && key_resp_2.status === PsychoJS.Status.NOT_STARTED) {
    ...
    frameRemains = 1 + 0.2 - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
